...
echo add ~jtraver/mmix/mmix_gnu/opt/mmix/bin to PATH

echo
echo running *.c
mmix-gcc -save-temps $MMIX_PROG.c -o $MMIX_PROG.mmo
# mmix-gcc $MMIX_PROG.c -o $MMIX_PROG.mmo
$MMIX_HOME/mmix-2 $MMIX_PROG.mmo

# -save-temps put MMS in *.s
echo
echo running *.s
$MMIX_HOME/mmixal-2 $MMIX_PROG.s
echo
echo running *.smms
# rm $MMIX_PROG.mmo
$MMIX_HOME/mmixal-2 $MMIX_PROG.smms
$MMIX_HOME/mmix-2 $MMIX_PROG.smmo
