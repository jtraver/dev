...
# export CLASSPATH=.
export CLASSPATH=/home/jtraver/dev/git/jtraver/dev/java/guiceberry8/my-app/target/classes;/home/jtraver/dev/git/jtraver/dev/java/guiceberry8/my-app/target/test-classes
